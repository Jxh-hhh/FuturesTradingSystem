...
<%--                                class="badge badge-warning">new</span>Page Progress Bar - Style--%>
<%--                            1--%>
<%--                        </a></li>--%>
<%--                        <li><a href="ui_blockui.html"> Block UI</a></li>--%>
<%--                        <li><a href="ui_bootstrap_growl.html"> <span--%>
<%--                                class="badge badge-roundless badge-warning">new</span>Bootstrap--%>
<%--                            Growl Notifications--%>
<%--                        </a></li>--%>
...
<%--                </a>--%>
<%--                    <ul class="sub-menu">--%>
<%--                        <li><a href="components_pickers.html"> Date & Time--%>
<%--                            Pickers</a></li>--%>
<%--                        <li><a href="components_context_menu.html"> Context Menu</a>--%>
<%--                        </li>--%>
<%--                        <li><a href="components_dropdowns.html"> Custom--%>
<%--                            Dropdowns</a></li>--%>
<%--                        <li><a href="components_form_tools.html"> Form Widgets &--%>
<%--                            Tools</a></li>--%>
<%--                        <li><a href="components_form_tools2.html"> Form Widgets--%>
<%--                            & Tools 2</a></li>--%>
...
<%--                </a>--%>
<%--                    <ul class="sub-menu">--%>
<%--                        <li><a href="form_controls_md.html"> <span--%>
<%--                                class="badge badge-roundless badge-danger">new</span>Material--%>
<%--                            Design<br> Form Controls--%>
<%--                        </a></li>--%>
<%--                        <li><a href="form_controls.html"> Bootstrap<br>--%>
<%--                            Form Controls--%>
<%--                        </a></li>--%>
...
<script src="assets/admin/layout4/scripts/layout.js"
        type="text/javascript"></script>
<script src="assets/admin/layout2/scripts/quick-sidebar.js"
        type="text/javascript"></script>
<script src="assets/admin/layout4/scripts/demo.js"
        type="text/javascript"></script>
<script src="assets/admin/pages/scripts/index3.js"
        type="text/javascript"></script>
