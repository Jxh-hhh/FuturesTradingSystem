...
<div class="content">
    ...
    <form class="login-form" action="login" method="post">
        ...
        <div class="form-group">
            ...
            请输入您的密码：<input class="form-control form-control-solid placeholder-no-fix"
        ...
        <div class="form-group">
            ...
            请再次确认您的密码：<input class="form-control form-control-solid placeholder-no-fix"
                   type="password" autocomplete="off" placeholder="Retype Password"
                   name="login_password" />
        </div>
